  ...
  return (
    <div className="w-full relative flex flex-col items-center gap-8 p-12 bg-gray-800/50 rounded-lg border border-gray-700 shadow-2xl overflow-visible">
      ...
      <div className="text-center">
        ...
        <p className="text-sm text-gray-400 mt-1 italic flex items-center justify-center gap-2">
          <span>High-fidelity cinematic output generated with Veo 3.1</span>
          {duration && (
            <>
              <span className="w-1 h-1 bg-gray-500 rounded-full"></span>
              <span className="text-indigo-400 font-mono">{duration.toFixed(1)}s</span>
            </>
          )}
        </p>
      </div>
      ...
      <div 
        ...
        } rounded-lg overflow-hidden bg-black shadow-[0_0_50px_rgba(79,70,229,0.2)] border border-indigo-500/30 transition-all duration-500 relative`}
      >
        <video
          ref={videoRef}
          src={videoUrl}
